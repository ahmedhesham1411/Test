...
public class FinishedOrdersViewModel {
    ...
    private List<OrdersModel.ResultBean.OrdersBean> orderFinishedList = new ArrayList<>();

    private Activity activity;
    private FinishedOrdersFragment fragment;

    public FinishedOrdersViewModel(FinishedOrdersFragment fragment) {
    ...
    private void getAcceptedOrders() {
        ...
        APIModel.getMethod(activity, "Client/GetOrdersCompleted", new TextHttpResponseHandler() {
            @Override
