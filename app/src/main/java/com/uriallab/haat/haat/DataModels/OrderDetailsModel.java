...
public class OrderDetailsModel {
    ...
    public static class ResultBean {
        ...
        private double Offer_Vat;
        private double Offer_App_Per;
        private OrderBean order;
        private List<ImgsBean> imgs;

        public double getOffer_Vat() {
            return Offer_Vat;
        }

        public void setOffer_Vat(double offer_Vat) {
            Offer_Vat = offer_Vat;
        }

        public double getOffer_App_Per() {
            return Offer_App_Per;
        }

        public void setOffer_App_Per(double offer_App_Per) {
            Offer_App_Per = offer_App_Per;
        }
        ...
        public static class OrderBean {
            ...
            private String Driver_Count_Rate;
            ...
            private String Ord_Payment_Status;
            ...
            public String getDriver_Count_Rate() {
                return Driver_Count_Rate;
            }

            public void setDriver_Count_Rate(String Driver_Count_Rate) {
            ...
            public String getOrd_Payment_Status() {
                return Ord_Payment_Status;
            }

            public void setOrd_Payment_Status(String Ord_Payment_Status) {
        ...
        public static class ImgsBean {
            ...
            public int getSerial_Section_ID() {
                return Serial_Section_ID;
            }

            public void setSerial_Section_ID(int Serial_Section_ID) {
                this.Serial_Section_ID = Serial_Section_ID;
            }
